...
export function serializeTimeProfile(
  ...
  return {
    ...
    // opt drop_frames
    // opt keep_frames
    // TODO: use prof.startTime as timeNanos, once units of startTime
    // and endTime confirmed.
    timeNanos: 1000 * 1000 * Date.now(),                    // Nanos
    durationNanos: 1000 * (prof.endTime - prof.startTime),  // Nanos
